            ...
            <div>
                ...
                <Tab.Container defaultActiveKey="Home">
                    <div className="listing-details-nav">                    
                        <div className="container">
                            <Nav as="ul" className="listing-nav nav justify-content-center">
                                <Nav.Item as="li">
                                    <Nav.Link className="" eventKey="Home"><i className="la la-home"></i><span>Home</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link  className="" eventKey="Description"><i className="la la-file-text"></i><span>Description</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link className="" eventKey="Features"><i className="la la-list-alt"></i><span>Listing Features</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link className="" eventKey="Photos"><i className="la la-image"></i><span>Photos</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link className=""  eventKey="Videos"><i className="la la-video-camera"></i><span>Videos</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link className="" eventKey="Events"><i className="la la-calendar-check-o"></i><span>Events</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item as="li">
                                    <Nav.Link className="" eventKey="Reviews"><i className="la la-star-o"></i><span>Reviews</span> </Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </div>                       
                    </div>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <div className="dropdown dropdown-btn">
                                                                        ...
                                                                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                            <Link className="dropdown-item site-button-link facebook" to={'3'}>
                                                                                <i className="fa fa-facebook"></i>
                                                                                <span>Facebook</span>
                                                                            </Link>
                                                                            <Link className="dropdown-item site-button-link twitter" to={'#'}>
